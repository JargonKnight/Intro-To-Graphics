# Source File Name: slotmachine - v0.4.py
...
Version: 0.4 - *Begin to implement labels and displaying the bet values etc
             - *Begin connecting buttons to the code and giving them functionality
             - *Keeping the mouse position tracker for location assistance
               when displaying labels etc..
...
def main():
    ...
    allSprites = pygame.sprite.Group(labelNoMoney, labelMoney, labelBet, labelCashWin, labelEvent, spinButton, betOneButton, maxBetButton, cashOutButton, resetButton)
                ...
                if spinButton_x < mouseX < spinButton_x + spinButton_width and spinButton_y < mouseY < spinButton_y + spinButton_height:
                    ...
                    if Prompt == "" and Turn >1:
                        ...
                        if Bet > Player_Money:
                            ...
                            Turn +=1
                            Prev_Bet = Bet
                            Player_Money, Jack_Pot, win, cashWin = pullthehandle(Bet, Player_Money, Jack_Pot, cashWin)
...
def pullthehandle(Bet, Player_Money, Jack_Pot, cashWin):
